...
<head>
  ...
  <title>The Wedding of Febro Herdyanto & Mustikasari</title>
  <meta content="Wedding Invitation - Febro Herdyanto and Mustikasari on Sept 2022" name="description">
  <meta content="Wedding Invitation" name="keywords">
  <?= $this->include('assetmain'); ?>
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h2 class="fontlatin">The Wedding of</h2><br>
      <h1 class="fontlatin">Febro & Mustika</h1>
      <br>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <img src="<?= base_url('/main/assets/img/bismillah.png'); ?>" height="80px" width="250px" class="image-fluid">
        ...
        <div class="row" style="text-align: center;"> <!-- === DEFINE PERSONAL DETAIL ===-->
          ...
          <div class="col-lg-2" data-aos="fade-up" style="text-align: center;"><br><img src="<?= base_url('/main/assets/img/simboldan.png'); ?>" width="150" height="200px"><br></div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="<?= base_url('/main/assets/img/portfolio/firstmeet.jpeg'); ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>First Meet</h4>
                <p>at SMK Negeri 1 Mejayan</p>
                <div class="portfolio-links">
                  <a href="<?= base_url('/main/assets/img/portfolio/firstmeet.jpeg'); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Our First Meet at SMK Negeri 1 Mejayan, Madiun on 2016"><i class="bx bx-zoom-in"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="<?= base_url('/main/assets/img/portfolio/2.jpg'); ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Engagement</h4>
                <p>at Madiun</p>
                <div class="portfolio-links">
                  <a href="<?= base_url('/main/assets/img/portfolio/2.jpg'); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Our Engagement at Madiun on May 31, 2021"><i class="bx bx-zoom-in"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="<?= base_url('/main/assets/img/portfolio/4.jpg'); ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Engagement</h4>
                <p>at Madiun</p>
                <div class="portfolio-links">
                  <a href="<?= base_url('/main/assets/img/portfolio/4.jpg'); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Our Engagement at Madiun on May 31, 2021"><i class="bx bx-zoom-in"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="<?= base_url('/main/assets/img/portfolio/prewed-1.jpg'); ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Our Prewedding</h4>
                <p>at Kebun Raya Bogor</p>
                <div class="portfolio-links">
                  <a href="<?= base_url('/main/assets/img/portfolio/prewed-1.jpg'); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Our Prewedding at Kebun Raya Bogor on July 3, 2022"><i class="bx bx-zoom-in"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="<?= base_url('/main/assets/img/portfolio/prewed-5.jpg'); ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Our Prewedding</h4>
                <p>at Kebun Raya Bogor</p>
                <div class="portfolio-links">
                  <a href="<?= base_url('/main/assets/img/portfolio/prewed-5.jpg'); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Our Prewedding at Kebun Raya Bogor on July 3, 2022"><i class="bx bx-zoom-in"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="<?= base_url('/main/assets/img/portfolio/prewed-4.jpg'); ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Our Prewedding</h4>
                <p>at Kebun Raya Bogor</p>
                <div class="portfolio-links">
                  <a href="<?= base_url('/main/assets/img/portfolio/prewed-4.jpg'); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Our Prewedding at Kebun Raya Bogor on July 3, 2022"><i class="bx bx-zoom-in"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="<?= base_url('/main/assets/img/portfolio/prewed-3.jpg'); ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Our Prewedding</h4>
                <p>at Kebun Raya Bogor</p>
                <div class="portfolio-links">
                  <a href="<?= base_url('/main/assets/img/portfolio/prewed-3.jpg'); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Our Prewedding at Kebun Raya Bogor on July 3, 2022"><i class="bx bx-zoom-in"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="<?= base_url('/main/assets/img/portfolio/prewed-6.jpg'); ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Our Prewedding</h4>
                <p>at Kebun Raya Bogor</p>
                <div class="portfolio-links">
                  <a href="<?= base_url('/main/assets/img/portfolio/prewed-6.jpg'); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Our Prewedding at Kebun Raya Bogor on July 3, 2022"><i class="bx bx-zoom-in"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="<?= base_url('/main/assets/img/portfolio/prewed-7.jpg'); ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Our Prewedding</h4>
                <p>at Kebun Raya Bogor</p>
                <div class="portfolio-links">
                  <a href="<?= base_url('/main/assets/img/portfolio/prewed-7.jpg'); ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Our Prewedding at Kebun Raya Bogor on July 3, 2022"><i class="bx bx-zoom-in"></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?= base_url('/main/assets/img/farhan.jpeg'); ?>" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?= base_url('/main/assets/img/farizal.jpeg'); ?>" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?= base_url('/main/assets/img/susi.jpeg'); ?>" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?= base_url('/main/assets/img/faza.jpeg'); ?>" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?= base_url('/main/assets/img/rani.jpg'); ?>" class="testimonial-img" alt="">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?= base_url('/main/assets/img/sindy.jpeg'); ?>" class="testimonial-img" alt="">
                <h3>Sindy Saputri</h3>
                <h4>Our Best Friends</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="<?= base_url('/main/assets/img/dean.jpeg'); ?>" class="testimonial-img" alt="">
    ...
    <section id="contact" class="contact">
      ...
      <div class="row">
          ...
          <div class="section-title">
            ...
            <form action="" method="post" role="form">
              <div class="form-group">
                ...
                <input type="hidden" name="nicknameGuest" value="">
                <label for="namaKehadiran" style="color: #b5b5bd;">Nama Anda</label>
                <input type="text" name="namaKehadiran" id="namaKehadiran" class="form-control" value="" placeholder="Masukkan Nama Anda" readonly>
              </div>
              <div class="form-group">
                <label for="statusKehadiran" style="color: #b5b5bd;">Status Kehadiran</label>
                <select class="form-control form-select" name="statusKehadiran" required readonly>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="pesan" rows="4" placeholder="Ketika Doa dan harapan kepada Pengantin" readonly></textarea>
              </div>
              <div class="text-center"><button class="btn btn-sm btn-secondary" name="simpanKehadiran" type="" disabled><i class="fa-solid fa-paper-plane"></i> Konfirmasi</button><br>
            <i style="font-family:Verdana, Geneva, Tahoma, sans-serif; font-size:10px; color: grey ;">This form is only for registered invitations</i><br>
            </div>            
            </form>
        </div>
        ...
        <div class="col-sm-4">
          ...
          <form action="<?= base_url('/guest/save-doa/') ?>" method="post" role="form">
              ...
              <div class="form-group">
                ...
                <input type="text" name="pengirimDoa" id="namaKehadiran" class="form-control" placeholder="Masukkan Nama Anda" required>
              </div>
              <div class="form-group">
                <label for="doaKehadiran" style="color: #b5b5bd;">Ucapan : </label>
                <textarea class="form-control" name="ucapanDoa" rows="4" placeholder="Ketika Doa dan harapan kepada Pengantin" required></textarea>
              </div>
              <div class="text-center"><button class="btn btn-sm btn-primary" name="simpanKehadiran" type="submit"><i class="fa-solid fa-paper-plane"></i> Kirim Doa</button></div>
            </form>
        </div>
        <div class="col-sm-4">
          <div class="section-title">
  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-sm-3">
          <img src="<?= base_url('/main/assets/img/mask.png'); ?>" class="rounded mx-auto d-block" width="100px" height="100px">
          Wajib Menggunakan Masker
        </div>
        <div class="col-sm-3">
          <img src="<?= base_url('/main/assets/img/handwash.png'); ?>" class="rounded mx-auto d-block" width="100px" height="100px">
          Cuci Tangan Menggunakan Sabun / <i>Hand Sanitizer</i>
        </div>
        <div class="col-sm-3">
          <img src="<?= base_url('/main/assets/img/vaccine.png'); ?>" class="rounded mx-auto d-block" width="100px" height="100px">
          Sudah Melakukan Vaksin COVID-19
        </div>
      </div>
      <div class="row d-flex justify-content-center">
        <div class="col-sm-3">
          <img src="<?= base_url('/main/assets/img/thermo.png'); ?>" class="rounded mx-auto d-block" width="100px" height="100px">
          Suhu Tubuh Tidak Lebih dari 38 &deg;C
        </div>
        <div class="col-sm-3">
          <img src="<?= base_url('/main/assets/img/distancing.png'); ?>" class="rounded mx-auto d-block" width="100px" height="100px">
          Menjaga Jarak Dengan Tamu Undangan
        </div>
        <div class="col-sm-3">
          <img src="<?= base_url('/main/assets/img/berjabat.png'); ?>" class="rounded mx-auto d-block" width="100px" height="100px">
  ...
  <!-- Vendor JS Files -->
  <script src="<?= base_url('/main/assets/vendor/aos/aos.js'); ?>"></script>
  <script src="<?= base_url('/main/assets/vendor/bootstrap/js/bootstrap.bundle.min.js'); ?>"></script>
  <script src="<?= base_url('/main/assets/vendor/glightbox/js/glightbox.min.js'); ?>"></script>
  <script src="<?= base_url('/main/assets/vendor/isotope-layout/isotope.pkgd.min.js'); ?>"></script>
  <script src="<?= base_url('/main/assets/vendor/php-email-form/validate.js'); ?>"></script>
  <script src="<?= base_url('/main/assets/vendor/purecounter/purecounter.js'); ?>"></script>
  <script src="<?= base_url('/main/assets/vendor/swiper/swiper-bundle.min.js'); ?>"></script>
  <script src="<?= base_url('/main/assets/vendor/typed.js/typed.min.js'); ?>"></script>
  <script src="<?= base_url('/main/assets/vendor/waypoints/noframework.waypoints.js'); ?>"></script>
