      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="section-title">
            ...
            <form action="<?= base_url('/'.$nick.'/main/save-kehadiran/') ?>" method="post" role="form">
              <div class="form-group">
                <input type="hidden" name="idGuest" value="<?= $idGuest ?>">
                <input type="hidden" name="nicknameGuest" value="<?= $nick ?>">
                <label for="namaKehadiran" style="color: #b5b5bd;">Nama Anda</label>
                <input type="text" name="namaKehadiran" id="namaKehadiran" class="form-control" value="<?php if($sapaanGuest == NULL){ echo $namaGuest; }else{ echo $sapaanGuest.". ".$namaGuest; } ?>" placeholder="Masukkan Nama Anda" required readonly>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="pesan" rows="4" placeholder="Ketika Doa dan harapan kepada Pengantin" required></textarea>
              </div>
              <div class="text-center"><button class="btn btn-sm btn-primary" name="simpanKehadiran" type="submit"><i class="fa-solid fa-paper-plane"></i> Konfirmasi</button></div>
            </form>
        </div>
        ...
        <div class="col-sm-4">
          ...
          <form action="<?= base_url('/'.$nick.'/main/save-doa/') ?>" method="post" role="form">
